...
export default function OrganiserDashboard() {
  ...
  useEffect(() => {
    async function loadUser() {
      ...
      setUser({ email: u.email, name: u.name || "Organiser", role });
    }
    loadUser();
  }, [router]);
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-[#94a3b8]">Manage your services & bookings</p>
          </div>
        ...
        <div className="glass-card p-6">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-full bg-gradient-to-br from-purple-500 to-purple-700 flex items-center justify-center text-xl font-bold">
            ...
            <span className="role-badge organiser ml-auto">{user.role}</span>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
          {[
            { label: "My Services", value: "—", icon: "🛎️" },
            { label: "Today's Bookings", value: "—", icon: "📋" },
