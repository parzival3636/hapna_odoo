...
export default function CustomerServices() {
  ...
  useEffect(() => {
    async function loadUser() {
      ...
      setUser({ email: u.email, name: u.name || "Customer", role });
    }
    loadUser();
  }, [router]);
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="glass-card p-6">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center text-xl font-bold">
            ...
            <span className="role-badge customer ml-auto">{user.role}</span>
          </div>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
          {[
            { label: "My Bookings", value: "—", icon: "🎫" },
